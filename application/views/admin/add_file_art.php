      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Add File Anggaran Rumah Tangga</a>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="col-12">
                      <br>
                      <form action="<?php echo base_url(); ?>admin/art_aksi" method="post" enctype="multipart/form-data">
        
                      <div class="row">
                        <div class="col-12 col-md-6">
                            <label>Upload File:</label>
                            <input type="file" name="filename" class="form-control rounded" placeholder="">
                        </div>
                      </div><br>

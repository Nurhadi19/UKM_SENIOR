      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Kartu Tanda Anggota</a>
          </div>
        </div>
      </nav>
      <!-- End Navbar -->
          ...
          <div class="col-md-8 ml-auto mr-auto">
            <div class="card card-upgrade">
              <div class="card-header text-center">
                <h4 class="card-title">Kartu Tanda Anggota</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table">
                    <tbody>
                        <td class="text-center">
                          <a target="_blank" class="btn btn-round btn-primary">Print Out</a>
                        </td>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="row">
            <nav class="footer-nav">
              <ul>
                ...
                <li><a href="https://www.creative-tim.com/blog" target="_blank">E-mail</a></li>
              </ul>
            </nav>

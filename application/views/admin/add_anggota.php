        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="col-12">
                      <br>
                      <form action="<?php echo base_url(); ?>admin/anggota_aksi" method="post" enctype="multipart/form-data">
        
                      <div class="row">
                        <div class="col-12 col-md-6">
                            <label>Nama Lengkap:</label>
                            <input type="text" name="nama" class="form-control rounded" placeholder="">
                        </div>
                        <div class="col-12 col-md-6">
                            <label>Keterangan:</label>
                            <input type="text" name="keterangan" class="form-control rounded" placeholder="">
                        </div>
                        <div class="col-12 col-md-6"><br>
                            <label>Status Anggota:</label>
                            <select class="form-control rounded" name="status_anggota">
                        ...
                        <div class="col-12 col-md-6"><br>
                            <label>No HP:</label>
                            <input type="text" name="hp" class="form-control rounded" placeholder="">
                        </div>
                        <div class="col-12 col-md-6"><br>
                            <label>Agama:</label>
                            <select class="form-control rounded" name="agama">
                        ...
                        <div class="col-12 col-md-6"><br>
                            <label>UK:</label>
                            <select class="form-control rounded" name="uk">
                        ...
                        <div class="col-12 col-md-6"><br>
                            <label>Periode:</label>
                            <input type="text" name="periode" class="form-control rounded" placeholder=""></input>
                        </div>
                        <div class="col-12 col-md-6"><br>
                            <label>Pentas:</label>
                            <input type="text" name="pentas" class="form-control rounded" placeholder=""></input>
                        </div>
                      </div><br>
